class MaintenancesController < ApplicationController
  ...
  def new
    if params[:device_id] and Device.find_by_id(params[:device_id])
      @maintenance = Maintenance.new
      @maintenance.device_id = params[:device_id]
    else
  ...
  def create
    ...
    respond_to do |format|
      if @maintenance.save
        format.html { redirect_to @maintenance.device, notice: 'Maintenance was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @maintenance.update(maintenance_params)
        format.html { redirect_to @maintenance.device, notice: 'Maintenance was successfully updated.' }
  ...
  private
    ...
    def maintenance_params
      params.require(:maintenance).permit(:device_id, :mdate, :location, :maintenancer_ids => [])
    end
end
